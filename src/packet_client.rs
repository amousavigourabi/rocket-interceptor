...
impl PacketClient {
    ...
    pub async fn send_packet(&mut self, packet_data: Vec<u8>, packet_port: u32) -> Result<Vec<u8>, Box<dyn std::error::Error>> {
...
mod tests {
    ...
    async fn assert_result() {
        ...
        let result = client.send_packet(packet_data, packet_port).await;
